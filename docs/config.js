const config = {
  ...
  "chapters": [
    {
      "title": "大村湾",
      "description": "真珠とナマコが名産品です。大村湾の天然真珠は古来より有名ですが、 現在は真珠の養殖が盛んです。大村湾のナマコは身が柔らかいです。",
    ...
    {
      "title": "筑紫平野",
      "description": "海抜約5m以下の低地では、クリークと呼ばれる水路が発達し、 独特の水郷景観を形成しています。米作が盛んです。",
    ...
    {
      "title": "阿蘇山",
      "description": "阿蘇山は世界最大級のカルデラです。",
      "hash": "10.82/32.9178/131.0562/109.3/63",
      "id": "chapter-3",
      "alignment": "right",
      "callback": null,
      "hidden": false,
    ...
    {
      "title": "大分",
      "description": "石油化学や鉄鋼の生産が盛んです。",
      "hash": "14.68/33.27065/131.67556/-116.9/80",
      "id": "chapter-4",
      "alignment": "right",
      "callback": null,
      "hidden": false,
